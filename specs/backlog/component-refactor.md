...
1. Create a detailed implementation plan document
    a. Loop through each item and do these things:
        - Use chrome tools to view the current UI related to each issue and take before screenshots and videos of the animations
        - write the file locations for the captures assets related to the item
        - Write details about the current issues and recommendations on how to improve the issue from a visual design standpoint
        - Write brief suggestion on how to address the issue technically
